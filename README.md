...
* [Supported Financial Markets](#-supported-financial-markets)
...
* **Multi-Language Support:** Production-ready trading scripts written primarily in **Python trading bot** frameworks and **JavaScript trading bot** structures.
...
Our algorithmic trading scripts are divided clean into dedicated sub-directories based on asset classes:

### 1. Crypto Trading Bots
Automate high-frequency, grid, or arbitrage strategies for digital assets. Fully optimized for **Bitcoin trading**, Ethereum, and high-liquidity altcoins.
...
The codebase handles native integrations with industry standard execution platforms and digital exchanges:

| Market | Native API Integrations |
| :--- | :--- |
